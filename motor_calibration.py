...
#running instructions This can ONLY work when connected to one blossom motor at a time. 
#FYI this script needs to be run multiple times!!! you will get  DxlPingPacket error first time
#this script can be used to set motor index
#should always run when attaching the wheels to the motors :)
